# dc-fastInvSqrtPipelined.tcl script 
#
...
#   report_power -hier
#   set_max_delay
#   write -format db -output fastInvSqrtPipelined.db
#
# Doesn't work quite the way I expect
#   NameDesign = fastInvSqrtPipelined    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output fastInvSqrtPipelined.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "fastInvSqrtPipelined"
...
analyze -format verilog fastInvSqrtPipelined.v
...
#===== Reports
write -format verilog -output fastInvSqrtPipelined.vg -hierarchy $NameDesign

report_area               > fastInvSqrtPipelined.area
report_cell               > fastInvSqrtPipelined.cell
report_hierarchy          > fastInvSqrtPipelined.hier
report_net                > fastInvSqrtPipelined.net
report_power              > fastInvSqrtPipelined.pow
report_timing -nworst 10  > fastInvSqrtPipelined.tim
